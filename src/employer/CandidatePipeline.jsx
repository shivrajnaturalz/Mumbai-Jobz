...
export default function CandidatePipeline(){
 ...
 useEffect(()=>{const onApproach=e=>{const c=e.detail;if(!c)return;setCandidates(cs=>cs.some(x=>x.id===c.id)?cs.map(x=>x.id===c.id?{...x,stage:'Approached'}:x):[...cs,{...c,stage:'Approached'}]);};window.addEventListener('candidate-approached',onApproach);return()=>window.removeEventListener('candidate-approached',onApproach);},[]);
